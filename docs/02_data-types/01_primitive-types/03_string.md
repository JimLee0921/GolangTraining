...
> 具体代码见 [string/main.go](../../../02_data-type/05_basic-types/03_string/main.go)
...
* 常见操作都在 `strings` 包和 `strconv` 包里。 见 [string/main.go](../../../02_data-type/05_basic-types/03_string/main.go)
